	...
	for (let i = 0; i < 19; i++) {
		for (let j = 0; j < 35; j++) {
			...
			if (tile === 0) {
				...
				else if (up && down && left && !right) arenaTiles[i][j] = { x: 0, y: 3 };
				else if (up && down && !left && right) arenaTiles[i][j] = { x: 0, y: 2 };
				else if (up && !down && left && right) arenaTiles[i][j] = { x: 0, y: 4 };
				...
				else if (!up && !down && !left && right) arenaTiles[i][j] = { x: 1, y: 4 };
				else if (!up && !down && left && !right) arenaTiles[i][j] = { x: 2, y: 4 };
				else if (up && down && !left && !right) arenaTiles[i][j] = { x: 1, y: 3 };
				else if (!up && !down && left && right) arenaTiles[i][j] = { x: 2, y: 3 };
				else if (up && !down && !left && right) arenaTiles[i][j] = { x: 1, y: 2 };
				else if (up && !down && left && !right) arenaTiles[i][j] = { x: 2, y: 2 };
				else if (!up && down && !left && right) arenaTiles[i][j] = { x: 1, y: 1 };
